...
<p align="center">
<img src="/images/https_ssh.PNG" alt="Olika alternativ för att clonea ett GitHub-repo" width="80%" height="auto" border="10" /><br>
</p>
...
<p align="center">
<img src="/images/github_login.PNG" alt="GitHub inloggningsfönster via Git Credential Manager for Windows" width="80%" height="auto" border="10" /><br>
</p>
...
...om man vill ändra ett SSH-klonat repo till HTTPS (notera `https`-prefixet i början av URL:en). Byt ut USERNAME mot dit användarnamn och REPOSITORY mot GitHub-repons officiella namn. Eller:
