...
**Uppdatering (21-04-2021):** Jag har nu testat på att använda Twitters API för att skapa en Twitter-bot som kvittrar ut den senaste covid19-vaccinationssatistiken för Sverige! Läs mer om det [här](https://datatjej.github.io/Vaccinationsboten-ett-miniprojekt/).