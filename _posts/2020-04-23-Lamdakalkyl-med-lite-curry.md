...
<font size="2">[[1]](#fotnot2) Ta till exempel en mening som "alla katter jamar", representerad som ∀x.katt(x) -> jamar(x) inom första ordningens logik. Uttrycket ∀x.katt(x) betyder isolerat "allting är en katt", medan det vi egentligen vill representera är "alla katter [gör nånting]".</font><br>