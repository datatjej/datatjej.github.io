...
Dialoger kännetecknas även av **initiativ**, vilket avser intiativet - och därmed kontrollen - som en eller flera talare har i dialogen och den riktning den tar. I naturligt förekommande dialoger brukar intitiativet vara mixat - man turas om att introducera nya samtalsämnen. Men i dialoger med system är det inte ovanligt att systemet har allt eller inget intiativ alls. Jämför exempelvis digitala kundserviceassistenter ("Uppge personnummer", "Uppge vilken typ av ärende samtalet gäller"...) och passiva hemassistenter som Alexa.
